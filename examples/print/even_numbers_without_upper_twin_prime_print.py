...
def main():
    parser = argparse.ArgumentParser(
        description="Print even numbers in a range that do not have any Goldbach pair with an upper twin prime."
    )
    parser.add_argument(
    ...
    print("Even numbers without any Goldbach pair with an upper twin prime:")
